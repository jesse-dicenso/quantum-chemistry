...
Molecule::Molecule(const std::string& file, const std::string& bfs){
...
std::vector<GF> AOfunctions(const std::string& bfs, int Zval, const std::vector<double>& pos, int atom_idx){
